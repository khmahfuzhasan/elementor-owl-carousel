<?php
class Elementor_news_slider_widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'news_slider_widget';
	}

	public function get_title() {
		return esc_html__( 'Aviation Slider News', 'aviation-slider' );
	}
	...
	public function get_keywords() {
		return [ 'slider', 'carousel','news','aviation' ];
	}
	...
	protected function render() {
        ...
        // The Loop
        echo '<div class="aviation-slider owl-carousel aviation-news">';
